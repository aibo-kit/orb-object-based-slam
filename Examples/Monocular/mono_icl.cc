...
int main(int argc, char **argv)
{
    if(argc != 2)
    {
        cerr << endl << "Usage: ./mono_icl path_to_sequence" << endl;
        return 1;
    }
  cout << "\033[1;31m change print color examples \032[0m "<< endl; // https://stackoverflow.com/questions/2616906/how-do-i-output-coloured-text-to-a-linux-terminal
    ...
    char bStop;
    cerr<< "MonoICL: Please type 'x'  "<<endl;
    while(bStop != 'x'){
        bStop = getchar();
    }
    // Stop all threads
